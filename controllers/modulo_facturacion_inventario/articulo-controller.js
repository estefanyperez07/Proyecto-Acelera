...
ArticuloController.getAllPorBodega = (req, res, next) => {
  ArticuloModel.getAllPorBodega((err, rows) => {
    if (err) {
      let locals = {
        title: "Error al consultar la base de datos",
        description: "Error de Sintaxis SQL",
...
ArticuloController.getAllActiveInv = (req, res, next) => {
  let id_categoria = req.params.id_categoria;
  ArticuloModel.getAllActiveInv((err, rows) => {
    if (err) {
      let locals = {
        title: "Error al consultar la base de datos",
        description: "Error de Sintaxis SQL",
...
ArticuloController.save = (req, res, next) => {
  let articulo = {
    ...
    inventario_maximo: req.body.inventario_maximo,
