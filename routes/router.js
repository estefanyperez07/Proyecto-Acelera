...
//--------------------------------COMENTARIOS DE SEGURIDAD -----------------
  ...
  .put("/categoria/actualizar-insertar/:cod_categoria",CategoriaController.save)
  ...
  .put("/descuento/actualizar-insertar/:cod_descuento",DescuentoController.save)
  ...
  .get("/articulo/getallbycategoria/:id_categoria",ArticuloController.getAllByCategoria)
  ...
  .put("/centro_costo/actualizar-insertar/:cod_centro_costo",CentroCostoController.save)
  .delete("/centro_costo/eliminar/:cod_centro_costo",CentroCostoController.delete)
  //****CORRELATIVO****
  ...
  .put("/metodo_pago/actualizar-insertar/:cod_metodo_pago",MetodoPagoController.save)
  ...
  .put("/modo_pedido/actualizar-insertar/:cod_modo_pedido",ModoPedidoController.save)
  ...
  .get("/unidad_medida/getone/:cod_unidad_medida",UnidadMedidaController.getOne)
  .put("/unidad_medida/actualizar-insertar/:cod_unidad_medida",UnidadMedidaController.save)
  .delete("/unidad_medida/eliminar/:cod_unidad_medida",UnidadMedidaController.delete)
  //****MAPA****
  ...
  .get("/lista_materiales/padregetone/:id_articulo_padre",ListaMaterialesController.padreGetAll)
  ...
  .put("/ms_pregunta_usuario/actualizar/:id_preguntas_usuario",PreguntasUsuarioController.update)
